      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-1">
            ...
            <p className="text-slate-400">Capture a new incoming stock movement.</p>
          </div>
        </div>
        ...
        <div className="panel p-8 text-center">
          ...
          <h3 className="text-xl font-semibold text-white mb-2">Receipt Created Successfully!</h3>
          <p className="text-slate-400 mb-4">Redirecting to receipts list...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div className="flex flex-col gap-1">
          <h2 className="text-3xl font-bold tracking-tight">Create Receipt</h2>
          <p className="text-slate-400">Capture a new incoming stock movement with scheduling and ownership details.</p>
        </div>
      </div>
              ...
              <div key={index} className="grid gap-4 md:grid-cols-4 p-4 rounded-xl bg-panelSoft">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-slate-300 pt-2">
                    {products.find(p => p.id === item.product_id)?.unit || 'pcs'}
                  </div>
                </div>
